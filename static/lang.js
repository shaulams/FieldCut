const LANGS = {
  en: {
    ...
    setup_hf_hint: 'Get one at <a href="https://huggingface.co/settings/tokens" target="_blank">huggingface.co/settings/tokens</a> (Read permission). Accept terms for: <a href="https://huggingface.co/pyannote/speaker-diarization-community-1" target="_blank">diarization</a>, <a href="https://huggingface.co/pyannote/segmentation-3.0" target="_blank">segmentation</a>, <a href="https://huggingface.co/pyannote/speaker-diarization-3.1" target="_blank">diarization-3.1</a>.',
  ...
  he: {
    ...
    setup_hf_hint: 'השיגו אחד ב-<a href="https://huggingface.co/settings/tokens" target="_blank">huggingface.co/settings/tokens</a> (הרשאת Read). אשרו תנאים עבור: <a href="https://huggingface.co/pyannote/speaker-diarization-community-1" target="_blank">diarization</a>, <a href="https://huggingface.co/pyannote/segmentation-3.0" target="_blank">segmentation</a>, <a href="https://huggingface.co/pyannote/speaker-diarization-3.1" target="_blank">diarization-3.1</a>.',
